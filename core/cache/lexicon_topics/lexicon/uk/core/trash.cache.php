<?php  return array (
  ...
  'trash.intro_msg' => 'Manage the deleted resources here. <br><i>Please check the publishing state, before you restore any resource.</i> You can (un-)publish resources directly from the grid with a double click on the published cell of the resource.',
